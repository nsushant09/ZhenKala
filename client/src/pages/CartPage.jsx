        ...
        {cart.items.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-16 mt-8">
            ...
            <div className="flex-grow">
              ...
              <div className="hidden sm:grid grid-cols-12 gap-4 pb-4 border-b border-gray-300 text-sm font-semibold text-gray-400 uppercase tracking-wider">
              ...
              <div className="divide-y divide-gray-200">
                {cart.items.map((item) => {
                  ...
                  return (
                    <div key={itemId} className="py-8 grid grid-cols-1 sm:grid-cols-12 gap-6 items-center group">
