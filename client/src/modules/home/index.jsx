...
import { useShop } from '@/app/providers/ShopContext';
  ...
  return (
    <div className="bg-background flex flex-col gap-[32px] mb-8">
      <motion.div
        ...
        viewport={{ once: true }}
        className="container bg-background min-h-screen flex flex-wrap flex-col gap-[32px]"
      >
        {/* Hero Banner */}
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="container bg-background py-16"
      >
        <h1
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        class="container flex flex-col md:flex-row bg-primary overflow-hidden justify-center items-center"
      >
